...
===팀 소개===
서울시립대학교 기계정보공학과 (20204300**) (이*은) (팀장)<br/>
서울시립대학교 기계정보공학과 (20184300**) (선*진) <br/>
서울시립대학교 기계정보공학과 (20184300**) (신*훈) <br/>
서울시립대학교 기계정보공학과 (20184300**) (이*현) <br/>
...
===프로젝트 개발 목표===
<br/>
[[파일:PM_목적계통도.png|700픽셀|섬네일|가운데|목적계통도]]
<br/>
*'''편의성'''
:(1) 직관성
::미용사와 직접 소통을 통해 헤어 스타일링을 받아야 하는 기존 시스템과는 다르게 키오스크를 통해 원하는 헤어스타일을 UI를 클릭하면서 직관적으로 확인할 수 있어야 한다. 별도의 어플리케이션 설치 없이 미용실을 이용하는 고객이 현장에서 바로 헤어스타일을 체험해볼 수 있어야 하고, 미용사 역시 본인의 스마트폰을 통해 편리하게 고객이 원하는 스타일을 받아볼 수 있도록 한다. <br/>
...
==동작 시나리오==
[[파일:PM_시나리오.png|700픽셀|섬네일|가운데|동작 시나리오]]

==역할분담 및 개발 일정==
===역할분담 ===
====이*은====
'''[프로젝트 총괄, 전체 페이지 기능 구현, 사진 촬영 기능 개발 ]'''


====선*진====
'''[헤어스타일 합성 및 염색 AI 모델 총괄]'''
...
====이*현====
'''[Firebase Database 구축, 미용사 예약 시스템 구현, 키오스크 UI 디자인]'''
...
===개발 일정===
[[파일:PM_개발일정.png|600픽셀|섬네일|가운데|개발 일정표]]
...
나누어진 총 4개의 part는 아래와 같다.


<div><ul class = "center">
<li style="display: inline-block;">[[파일:2023_hk_ft.png|225픽셀|섬네일|가운데|전면 상단 part]]</li>
<li style="display: inline-block;">[[파일:2023_hk_fb.png|180픽셀|섬네일|가운데|전면 하단 part]]</li>
<li style="display: inline-block;">[[파일:2023_hk_bt.png|180픽셀|섬네일|가운데|후면 상단 part]]</li>
<li style="display: inline-block;">[[파일:2023_hk_bb.png|225픽셀|섬네일|가운데|후면 상단 part]]</li>
</ul></div>
...
<div><ul class = "center">
<li style="display: inline-block;">[[파일:2023_hk_front.png|275픽셀|섬네일|가운데|완성된 키오스크 정면]]</li>
<li style="display: inline-block;">[[파일:2023_hk_side.png|181픽셀|섬네일|가운데|완성된 키오스크 측면]]</li>
</ul></div>
...
[[파일:PM Start Frame.png|400픽셀|섬네일|가운데|시작 페이지]]
...
[[파일:PM Open win1.png|400픽셀|섬네일|가운데|로그인 선택 페이지]]
...
[[파일:PM Open win2.png|400픽셀|섬네일|가운데|회원가입 페이지]]
...
[[파일:PM Open win3 000.png|400픽셀|섬네일|가운데|로그인 페이지]]
...
[[파일:PM Open win4.png|400픽셀|섬네일|가운데|서비스 선택 페이지]]
...
[[파일:PM Open win5.png|400픽셀|섬네일|가운데|사진 촬영 페이지]]
...
[[파일:PM Open win6.png|400픽셀|섬네일|가운데|헤어스타일 선택 페이지]]
...
[[파일:PM Open win11.png|400픽셀|섬네일|가운데|합성 결과 확인 페이지]]
...
[[파일:PM Open win12.png|400픽셀|섬네일|가운데|예약 페이지]]
...
[[파일:PM Open win13.png|400픽셀|섬네일|가운데|종료 페이지]]
...
[[파일:헤어스타일모델.JPG|700픽셀|섬네일|가운데|전체 헤어스타일 합성 과정]]
...
<div><ul class = "center">
<li style="display: inline-block;">[[파일:황금비율마스크.png|50픽셀]|섬네일|황금비율 마스크]]</li>
<li style="display: inline-block;">[[파일:81 landmakr.jpg|200픽셀|섬네일|랜드마크]]</li>
</ul></div>
...
[[파일:Style-your-hair.png|600픽셀|섬네일|가운데|Style_Your_Hair]]
...
[[파일:Embedding.jpg|700픽셀|섬네일|가운데|임베딩 과정]]
...
[[파일:Dying.jpg|700픽셀|섬네일|가운데|Segmentation 과정]]
...
| 고객의 ID
| gender
| 고객의 성별 지정<br/>'남자' 혹은 '여자' 값만 저장
| string
|-
| -
| id
| 고객의 ID<br/>중복 허용하지 않음
| string
|-
| -
| name
...
| -
| shape
| 고객의 얼굴형 저장<br/>이는 사진 촬영 후 분석 후에 저장된다.
| string
|}
...
[[파일:PM_Cloud_Firestore.PNG|700픽셀|섬네일|가운데|Cloud FireStore]]

* Storage
: Storage에는 남성/여성의 헤어스타일 정보와 염색 정보를 저장한다.

<div><ul class = "center">
<li style="display: inline-block;">[[파일:PM_Storage1.png|500픽셀|섬네일|가운데|Storage]]</li>
<li style="display: inline-block;">[[파일:PM_Storage2.png|475픽셀|섬네일|가운데|Storage]]</li>
</ul></div>
...
[[파일:2023_hk_kakaotalk_main.png|700픽셀|섬네일|가운데|"프린세스메이커" 카카오톡 플러스친구 채널]]

<br/>
<div><ul class = "center">
<li style="display: inline-block;">[[파일:2023_hk_kakaotalk2.jpg|250픽셀|섬네일|가운데|고객에게 전송된 사진과 예약내역]]</li>
<li style="display: inline-block;">[[파일:2023_hk_kakaotalk1.jpg|243픽셀|섬네일|가운데|디자이너에게 전송된 사진과 예약내역]]</li>
</ul></div>
...
<div><ul class = "center">
<li style="display: inline-block;">[[파일:PM Start Frame.png|200픽셀|섬네일|가운데|시작 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win1.png|200픽셀|섬네일|가운데|로그인 선택 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win2.png|200픽셀|섬네일|가운데|회원가입 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win3 000.png|200픽셀|섬네일|가운데|로그인 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win4.png|200픽셀|섬네일|가운데|서비스 선택 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win5.png|200픽셀|섬네일|가운데|사진 촬영 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win6.png|200픽셀|섬네일|가운데|헤어스타일 선택 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win11.png|200픽셀|섬네일|가운데|합성 결과 확인 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win12.png|200픽셀|섬네일|가운데|예약 페이지]]</li>
<li style="display: inline-block;">[[파일:PM Open win13.png|200픽셀|섬네일|가운데|종료 페이지]]</li>
</ul></div>
...
====발표 포스터====
[[파일:PM_Final 포스터.pdf|500픽셀|섬네일|가운데|발표 포스터]]
...
<div><ul class = "center">
<li style="display: inline-block;">[[파일: 2023_hk_d.png|600픽셀|섬네일|가운데|결과물 요구사항]]</li>
</ul></div>


<div><ul class = "center">
<li style="display: inline-block;">[[파일: 2023_hk_survey1.jpg|500픽셀|섬네일|가운데|설문조사 1페이지]]</li>
<li style="display: inline-block;">[[파일: 2023_hk_survey2.jpg|500픽셀|섬네일|가운데|설문조사 2페이지]]</li>
</ul></div>
...
[[파일:PM 부문별.png|600픽셀|섬네일|가운데|부문별 만족도 조사 평균]]


<div><ul class = "center">
<li style="display: inline-block;">[[파일:PM 합성.png|400픽셀|섬네일|가운데|헤어스타일 합성 만족도]]</li>
<li style="display: inline-block;">[[파일:PM 염색.png|400픽셀|섬네일|가운데|염색 만족도]]</li>
<li style="display: inline-block;">[[파일:PM 소요시간.png|400픽셀|섬네일|가운데|합성 소요 시간 만족도]]</li>
</ul></div>
