...
if __name__ == "__main__":
    ...
    # I/O arguments
    parser.add_argument('--input_dir', type=str, default='/workspace/Barbershop/input/face',
                        help='The directory of the images to be inverted')
    parser.add_argument('--output_dir', type=str, default='./output/',
                        help='The directory to save the output images')
    parser.add_argument('--im_path1', type=str, default='source3.png', help='Identity image')
