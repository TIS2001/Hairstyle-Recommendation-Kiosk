...
#     W_embedding_dir = os.path.join("./output/", "W+")
#     FS_embedding_dir = os.path.join("./output/", "FS")

#     im_paths_not_embedded = []
    
#     assert os.path.isfile(im_paths[1])

#     im_name = os.path.splitext(os.path.basename(im_paths[1]))[0]
#     W_exists = os.path.isfile(os.path.join(W_embedding_dir, "target.npy"))
...
def img_maker(args,img,align):
    ...
    im_path1 = os.path.join(args.input_dir, "target.png")
