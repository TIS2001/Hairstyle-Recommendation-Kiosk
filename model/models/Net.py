...
# from models.Mobilestyegan.core.models.mobile_synthesis_network import MobileSynthesisNetwork as Generator
import numpy as np
import os
...
class Net(nn.Module):
    ...
    def __init__(self, opts):
        ...
        # self.generator = Generator(opts.size, opts.latent)
        self.cal_layer_num()
        self.load_weights()
        self.load_PCA_model()
